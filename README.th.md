...
| `instructions/COURSE_AI_INSTRUCTIONS.th.md` | คำอธิบายภาษาไทยของคำสั่ง AI coach ของรายวิชา |
...
ไฟล์ `.th.md` ภาษาไทยมีให้สำหรับ README, คำสั่ง AI ของรายวิชา และเอกสาร workflow

ไฟล์ภาษาอังกฤษยังคงเป็นไฟล์หลักสำหรับ AI tools และ coding agents
...
| AI coding tools อื่น ๆ เฉพาะเมื่อผู้สอนอนุญาตอย่างชัดเจน | `workflows/STUDENT_WORKFLOW_CODING_TOOLS.md` |
...
ถ้าผู้สอนอนุญาตให้ใช้ GitHub Copilot หรือ VS Code AI extension อื่นอย่างชัดเจน นักศึกษายังต้องทำตาม `workflows/STUDENT_WORKFLOW_CODING_TOOLS.md`, เขียนและทดสอบโค้ดสุดท้ายใน VS Code, ส่ง OJ ด้วยตนเอง และเปิดเผยการใช้ AI ใน `ai_reflection.md` เมื่อโจทย์นั้นเป็น learning-log-required
...
ถ้านักศึกษาใช้ AI coding tool อื่นที่ผู้สอนอนุญาตอย่างชัดเจน ให้ทำตาม:

```text
workflows/STUDENT_WORKFLOW_CODING_TOOLS.md
```

และทำตามคำสั่งเพิ่มเติมที่ผู้สอนให้
