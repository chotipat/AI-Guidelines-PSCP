...
| `instructions/COURSE_AI_INSTRUCTIONS.md` | คำสั่งหลักสำหรับ AI coach เช่น ChatGPT, Claude, Gemini และเครื่องมือคล้ายกัน |
| `instructions/COURSE_AI_INSTRUCTIONS.th.md` | คำอธิบายภาษาไทยของคำสั่ง AI coach |
| `instructions/AGENTS.md` | กฎกลางสำหรับ coding agents เช่น Codex, Claude Code, Gemini CLI |
| `instructions/CLAUDE.md` | Claude Code instruction wrapper ที่ import `AGENTS.md` |
| `instructions/GEMINI.md` | Gemini CLI instruction wrapper ที่ import `AGENTS.md` |
...
| `workflows/STUDENT_WORKFLOW_GEMINI_CLI.md` | Workflow สำหรับ Gemini CLI และ Gemini Code Assist agent mode เมื่อผู้สอนอนุญาต |
...
| `examples/` | ตัวอย่างไฟล์ที่เขียนเสร็จแล้วเพื่อดูระดับรายละเอียดที่คาดหวัง |
...
| Gemini CLI หรือ Gemini Code Assist agent mode เมื่อผู้สอนอนุญาต | `workflows/STUDENT_WORKFLOW_GEMINI_CLI.md` |
...
ให้นักศึกษาสร้าง folder หลัก เช่น:
...
ห้าม upload `main.py`, `solution.py` หรือ source code files อื่น ๆ ไปไว้ใน public GitHub learning log

ให้ใช้ OJ submission ID ใน `submission.md` แทน

---

## 6. หมายเหตุสำหรับผู้ใช้ Claude Code
...
Claude Code อ่าน project instructions จากไฟล์ชื่อ:

    CLAUDE.md

Repository นี้เตรียมไฟล์ wrapper ไว้ที่:

    instructions/CLAUDE.md

ไฟล์นี้ import กฎกลางของรายวิชาจาก:

    instructions/AGENTS.md

นักศึกษาควร copy ทั้งสองไฟล์ไปไว้ใน local course folder:
...
ห้ามเขียน `CLAUDE.md` เอง

ห้าม copy instruction แปลก ๆ จาก internet ไปใส่ `CLAUDE.md`

ให้เริ่ม Claude Code จาก folder `pscp` เสมอ เพื่อให้ Claude Code อ่าน `CLAUDE.md` ได้

---

## 7. หมายเหตุสำหรับผู้ใช้ Gemini CLI

ถ้าใช้ Gemini CLI ให้อ่าน:
...
Gemini CLI อ่าน project context จากไฟล์ชื่อ:
...
ห้ามเขียน `GEMINI.md` เอง

ห้าม copy instruction แปลก ๆ จาก internet ไปใส่ `GEMINI.md`

ให้เริ่ม Gemini CLI จาก folder `pscp` เสมอ เพื่อให้ Gemini CLI อ่าน `GEMINI.md` ได้

ห้ามใช้ YOLO mode หรือ auto-accept mode เว้นแต่ผู้สอนอนุญาตอย่างชัดเจน

---

## 8. สิ่งที่นักศึกษาต้องเขียนเอง
...
## 10. Workflow โดยรวมสำหรับ OJ ทุกข้อ
...
## 12. ความรับผิดชอบเมื่อใช้ AI กับโจทย์ที่ไม่ต้องส่ง learning log
...
## 13. เมื่อไรต้องใช้ `submission.md`
...
## 14. เมื่อไรต้องใช้ `ai_reflection.md`
...
3. OJ status
4. ใช้ AI tool อะไร
5. ใช้ไฟล์ instruction ใด เช่น `COURSE_AI_INSTRUCTIONS.md`, `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`
...
## 15. โครงสร้าง GitHub Repository ของนักศึกษา
...
## 16. ในแต่ละ Learning Log Folder ควรมีอะไร
