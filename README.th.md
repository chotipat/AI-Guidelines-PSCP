...
| `policies/LAB_COMPUTER_USAGE.md` | นโยบายการใช้เครื่องคอมพิวเตอร์ร่วมกันในห้อง Lab |
| `policies/LAB_COMPUTER_USAGE.th.md` | นโยบายภาษาไทยสำหรับการใช้เครื่องคอมพิวเตอร์ร่วมกันในห้อง Lab |
...
| `templates/SUBMISSION_TEMPLATE.th.md` | Template ภาษาไทยสำหรับสร้าง `submission.md` |
...
| `templates/AI_REFLECTION_TEMPLATE.th.md` | Template ภาษาไทยสำหรับสร้าง `ai_reflection.md` |
...
อ่าน `policies/LAB_COMPUTER_USAGE.th.md` ก่อนใช้เครื่องคอมพิวเตอร์ร่วมกันในห้อง Lab

เมื่อใช้เครื่อง Lab ร่วมกัน นักศึกษาต้องใช้ folder ของตนเองในรูปแบบ `pscp-<student-id>/`, logout จาก account ทั้งหมดหลังใช้งาน และตรวจสอบว่าเครื่องมือ AI ไม่ได้อ่านไฟล์ของนักศึกษาคนอื่น
...
ไฟล์ `.th.md` ภาษาไทยมีให้สำหรับ README, policies, เอกสาร workflow, templates และตัวอย่าง
...
ให้แทน `<problem-id>` ด้วยเลขโจทย์ OJ แบบ 4 หลัก

ห้ามใช้ลำดับข้อที่นักศึกษาทำเองแทนเลขโจทย์
...
### Folder สำหรับเขียน Code กับ Folder สำหรับ Learning Log

นักศึกษาควรแยก folder สำหรับเขียน code ออกจาก folder สำหรับ GitHub learning log
...
สำหรับเขียน code ทดสอบ code และเก็บไฟล์ชั่วคราวในเครื่อง
...
folder ที่มี `_work` ใช้สำหรับทำงานในเครื่องเท่านั้น

ห้าม push `oj<problem-id>_work/` ขึ้น GitHub

ห้ามใส่ full source code files เช่น `main.py` ใน GitHub learning log

ให้ใช้ OJ submission ID ใน `submission.md` แทน

แนะนำให้มี `.gitignore` ใน repository ของนักศึกษา ดังนี้:
...
ไฟล์นี้ช่วยป้องกันไม่ให้นักศึกษาเผลอ push code, ไฟล์ชั่วคราว หรือไฟล์ส่วนตัวขึ้น GitHub
...
`<problem-id>` ต้องเป็นเลขโจทย์ OJ แบบ 4 หลัก ไม่ใช่ลำดับข้อที่นักศึกษาทำ
...
- full source code files เช่น `main.py`
...
ห้ามใส่ `main.py` ใน GitHub learning log
