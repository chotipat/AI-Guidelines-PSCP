...
| `workflows/STUDENT_WORKFLOW_CODING_TOOLS.md` | Workflow ทั่วไปสำหรับ AI coding tools ที่ผู้สอนอนุญาต |
| `workflows/STUDENT_WORKFLOW_CODING_TOOLS.th.md` | Workflow ภาษาไทยสำหรับ AI coding tools ที่ผู้สอนอนุญาต |
...
- Gemini web chat ยังใช้ได้ในฐานะ web chat AI ถ้าผู้สอนอนุญาต
...
## 7. Workflow โดยรวมสำหรับ OJ ทุกข้อ
...
## 7. ความรับผิดชอบเมื่อใช้ AI กับโจทย์ที่ไม่ต้องส่ง learning log
...
## 7. เมื่อไรต้องใช้ `submission.md`
...
## 7. เมื่อไรต้องใช้ `ai_reflection.md`
...
## 7. โครงสร้าง GitHub Repository ของนักศึกษา
...
## 7. ในแต่ละ Learning Log Folder ควรมีอะไร
